...
4.	Если внутри двумерного массива один или несколько из вложенных массивов содержит больше или меньше трех значений, то сортировка не выполняется, а на консоль необходимо вывести сообщение “Unavailable data at index #” (# - индекс элемента в двумерном массиве).
5.	Если внутри двумерного массива один или несколько из вложенных массивов содержит null, то сортировка не выполняется, а на консоль выводится сообщение: “Empty data at index #” (# - индекс элемента в двумерном массиве).
