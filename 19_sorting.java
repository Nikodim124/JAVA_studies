...
1. В классе должен быть реализован публичный статичный свободный метод sortInts, который принимает в качестве параметров массив целых чисел типа int. 
Метод должен выполнять сортировку массива по возрастанию. Алгоритм сортировки может быть любым.
2. В классе должен быть реализован публичный статичный свободный метод sortDoubles, который принимает в качестве параметров массив элементов класса-обертки Double. 
Метод должен выполнять сортировку массива по возрастанию. Алгоритм сортировки может быть любым. Все элементы null должны перемещаться в конец массива.
