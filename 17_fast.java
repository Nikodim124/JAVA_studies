...
Системный аналитик проанализировал метод сортировки sortSales, использованный для сортировки данных о продажах компании PineApple, и сформулировал новое системное требование.
...
Метод должен принимать массив строк, содержащих наименование/идентификатор анализируемой бизнес-единицы (это может быть как страна, так и отдельный магазин) в качестве первого параметра.
...
Данные, которые будут передаваться в метод, по умолчанию синхронизированы (0-й элемент массива данных о продажах соответствует 0-му элементу массива бизнес-единиц, 1-й – 1-му и т.д.).
...
Во всех остальных случаях необходимо выполнить сортировку обоих массивов с учетом следующих требований:
	...
	-сортировка должна происходить синхронно, т. е. если осуществляется перестановка значений в массиве данных о продажах, должна осуществляться аналогичная (по индексам) перестановка в массиве названий/идентификаторов бизнес-единиц;
