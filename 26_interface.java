/*
У компании существует три типа работников: с почасовой зарплатой, месячной и недельной. Требуется создать для каждого классы и общий интерфейс Staff, в котором будет метод int calculateSalary(int salary) для расчета зарплаты.  Все классы реализовать в пакете com.intellekta.staff.
