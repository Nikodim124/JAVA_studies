...
необходимо использовать двунаправленный алгоритм сортировки выбором, в котором за один проход одновременно находятся 
и переставляются максимальный элемент (в конец неотсортированной части массива) и минимальный элемент (в начало неотсортированной части массива);
